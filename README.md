...
частей — шасси, корпуса, дула, перка и СТИХИИ: 1800 комбинаций, у каждой своя
цена. Стихия (огонь, вода, земля, ток, воздух) заряжает каждый ваш снаряд.
В ангаре можно сыграть в ЖРЕБИЙ: взять проклятья — и открыть за них
облегчения (плата — очки). В бою капают ОЧКИ за урон, раунды и победу,
рекорд сохраняется. Комбо «Лазер + Веер» стреляет ЛАЗЕРНЫМ ВЕЕРОМ —
тремя лучами разом. Восемь арен, 10 бонусов (стены, мины, лазер, дым, ЭМИ),
5 раундов до победы.
...
Версия игры показана в главном меню внизу справа (сейчас v1.6).
...
## Собери свой танк: 1800 комбинаций
...
или на чужую мину. У бота стихия тоже своя — смотрите HUD.
...
## Жребий: проклятья и облегчения (R / T / V)

Шестой ряд ангара — жребий: 4 проклятья (красные карты) и 4 облегчения
(зелёные). **R/T** двигают курсор, **V** берёт/снимает карту. Правило
честного обмена:

- **Без проклятий можно взять максимум ОДНО облегчение.**
- Каждое взятое проклятье открывает ещё одно облегчение (максимум 3 проклятья
  и 4 облегчения).
- Сняли проклятье — лишние облегчения снимаются сами.
- Плата за жребий — ОЧКИ: проклятье режет их на 15%, облегчение — на 10%
  (не ниже x0.30). Множитель виден в ангаре и в HUD.
...
Живой счёт виден в HUD под счётом раунда («ОЧКИ 123 · жребий x0.75»),
итог — на экране конца матча, умноженный на множитель жребия.
Лучший результат сохраняется в `duel_stats.json` и показывается в меню
(«Рекорд очков»). Хотите больше очков — играйте без жребия; хотите
мощнее танк — берите проклятья и платите очками.
...
game.py        — состояния игры, барьеры, мины, ангар (5 панелей + жребий), очки, HUD
