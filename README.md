...
боты (двое и больше) до 70 СЕКУНД выясняют, кто сильнее, — победившего
засчитываем; не успели — все умирают, раунд ничья; кнопка «УБИТЬ СРАЗУ»
заканчивает ожидание мгновенно. А ещё есть КОНСОЛЬ РАЗРАБОТЧИКА (Ё):
...
Версия игры показана в главном меню внизу справа (сейчас v2.5).
...
## ПОСЛЕ ВАШЕЙ СМЕРТИ: боты выясняют победителя 70 секунд

По ТЗ игрока (v2.5): **неуязвимости ботов больше НЕТ** — бить их можно
с первой секунды раунда. Зато когда ВЫ погибаете, а живых ботов осталось
двое или больше (FFA), раунд не мигом заканчивается: ботам даётся **70 секунд**
на «выяснение отношений». Один бот одолел остальных — ЕМУ и засчитывается
победа в раунде (в 1на1 бот-одиночка берёт раунд сразу). Не успели никто —
по истечении 70 секунд ВСЕ живые боты умирают, раунд — НИЧЬЯ. На HUD тикает
«БОТЫ ВЫЯСНЯЮТ ОТНОШЕНИЯ — ДОХНУТ ЧЕРЕЗ 54 С (НИЧЬЯ)», а рядом кнопка
**«УБИТЬ СРАЗУ»** — нажали, и все враги мгновенно доезжают до взрыва (тоже
ничья, но ждать не пришлось). В консоли окно крутится командой
«ждать 70» / «ждать 0».
...
- **После вашей смерти** — окно выяснения на 70 секунд (см. раздел выше):
  победившему боту — победа, никому — ничья.
...
- **Чит-команды:** «хп 200 Бот» — выставить прочность; «убить [кому]» —
  убить (по умолчанию всех врагов); «ждать 70» — окно выяснения после вашей
...
arena.py       — большой мир 2240x1260 (x3 старой карты), 16 арен + рандомизация (зеркало, баррикады)
