...
Восемь арен, 10 бонусов (стены, мины, лазер, дым, ЭМИ), 5 раундов до победы.
...
Версия игры показана в главном меню внизу справа (сейчас v1.5).
...
**F/G** — стихия, **Enter** — в бой. В главном меню: **1/2/3** — сложность бота.
...
game.py        — состояния игры, барьеры, мины, ангар на 5 панелей, HUD
