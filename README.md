...
ШЕСТНАДЦАТЬ БОЛЬШИХ арен (мир 1920×1080 — камера едет за вами, миникарта
...
Версия игры показана в главном меню внизу справа (сейчас v2.3).
...
- **КАРТЫ ПОБОЛЬШЕ (v2.2): мир вырос до 1920×1080** — окно показывает только
  часть поля, камера плавно едет за вашим танком (если вы погибли — за
  живым), а в правом нижнем углу появилась **МИНИКАРТА**: препятствия,
...
arena.py       — большой мир 1920x1080, 16 арен + рандомизация (зеркало, баррикады)
