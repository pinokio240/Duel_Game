...
PU_INFO = {
    ...
    # ----- v2.9: турель и разрывные (v3.2: турель теперь ПОСТОЯННАЯ) -----
    "turret": {"letter": "Т", "color": (120, 230, 150), "name": "ТУРЕЛЬ",
               "hint": "ставится по R: сама стреляет по чужакам, постоянная"},
    "he":      {"letter": "Р", "color": (255, 120, 50), "name": "РАЗРЫВНЫЕ",
               "hint": "6 выстрелов с осколками: задевает чужаков рядом"},
    # ----- v3.2: ПРОЧНЫЕ СТЕНЫ (просьба игрока) — по Q ставятся после обычных -----
    "wall_strong": {"letter": "П", "color": (110, 200, 255),
                    "name": "ПРОЧНАЯ СТЕНА",
                    "hint": "2 стены: переживают 8 любых выстрелов"},
    "wall_heavy":  {"letter": "О", "color": (255, 200, 80),
                    "name": "ОЧЕНЬ ПРОЧНАЯ",
                    "hint": "2 стены: переживают 12 любых выстрелов"},
    "wall_ultra":  {"letter": "Н", "color": (255, 110, 200),
                    "name": "НЕВЕРОЯТНО ПРОЧНАЯ",
                    "hint": "1 стена: переживает 16 любых выстрелов"},
}
