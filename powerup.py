...
PU_INFO = {
    ...
    # ----- стихии: 4 элементальных снаряда -----
    "fire":   {"letter": "О", "color": (255, 110, 0), "name": "ОГОНЬ",
               "hint": "4 снаряда: поджигают, броня не спасает"},
    "water":  {"letter": "А", "color": (80, 170, 255), "name": "ВОДА",
               "hint": "4 снаряда: смывают бонусы врага"},
    "earth":  {"letter": "З", "color": (180, 130, 60), "name": "ЗЕМЛЯ",
               "hint": "4 снаряда: враг вязнет на 2.5 сек"},
    "electric": {"letter": "Т", "color": (255, 240, 110), "name": "ТОК",
               "hint": "4 снаряда: глушат мотор на 1.3 сек"},
    "air":    {"letter": "Ю", "color": (190, 235, 255), "name": "ВОЗДУХ",
               "hint": "4 снаряда: отшвыривают врага"},
    # ----- стена-бустер -----
